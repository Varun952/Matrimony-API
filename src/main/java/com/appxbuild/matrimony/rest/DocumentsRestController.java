...
public class DocumentsRestController {
    ...
    private Documents addDocument(@RequestBody Documents theDocuments){
    ...
    private Documents updateDocument(@RequestBody Documents theDocuments){
        LocalDateTime localDateTime = LocalDateTime.now();
    ...
    // add mapping for DELETE "/documents/{agency_userId}" to delete document
    @DeleteMapping("/documents/{documentId}")
    private String deleteDocument(@PathVariable int documentId){
        Documents theDocument = documentsService.findById(documentId);
