...
@Service
public class FavouriteUserProfileServiceImpl implements FavouriteUserProfileService {

    private FavouriteUserProfileDAO favouriteUserProfileDAO;

    @Autowired
    public FavouriteUserProfileServiceImpl(FavouriteUserProfileDAO theFavouriteUserProfileDAO){
