...
public class Users {
    ...
    @JsonIgnoreProperties("users")
    private UserRelatives userRelatives;
    ...
    public Users(String userName, String password, String email, String firstName, String middleName, String lastName, Byte active, int userStatuses, String otp, String mobile, String facebookIdentification, String facebookToken, String googleIdentification, String googleToken, String appleIdentification, String appleToken, Double latitude, Double longitude, String passwordToken, LocalDateTime passwordTokenExpire, String confirmEmailToken, byte emailVerified, int userRelative, int parentId, String shortCode, LocalDateTime created, LocalDateTime modified) {
    ...
    public UserRelatives getUserRelatives() {
        return userRelatives;
    }

    public void setUserRelatives(UserRelatives userRelatives) {
