...
public class Subscriptions {
    ...
    public Subscriptions(String name, Users users, Integer agent, Packages packages, Double actualCost, Double discount, Double discountedCost, Double gst, Double finalCost, Double agentCommission, LocalDateTime startDate, LocalDateTime endDate, SubscriptionStatuses subscriptionStatuses, LocalDateTime created, LocalDateTime modified, Transactions transactions) {
        this.name = name;
        this.users = users;
        this.agent = agent;
